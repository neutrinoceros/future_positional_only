...
@pytest.mark.parametrize(
    ...
    [
        pytest.param(
            ...
            (),
            {"a": 1, "b": 2, "c": 3, "d": 4},
            r"Passing 'a' as keyword is deprecated",
        ...
        pytest.param(
            ...
            (1,),
            {"b": 2, "c": 3, "d": 4},
            r"Passing 'b' as keyword is deprecated",
        ...
        pytest.param(
            ...
            (),
            {"a": 1, "b": 2, "c": 3, "d": 4},
            r"Passing \['a', 'b'\] arguments as keywords is deprecated",
        ...
        pytest.param(
            ...
            (),
            {"a": 1, "b": 2, "c": 3, "d": 4},
            r"Passing \['a', 'b', 'c', 'd'\] arguments as keywords is deprecated",
        ...
        pytest.param(
            ...
            (1,),
            {"b": 2, "c": 3, "d": 4},
            r"Passing \['b', 'c', 'd'\] arguments as keywords is deprecated",
        ...
        pytest.param(
            ...
            (1, 2),
            {"c": 3, "d": 4},
            r"Passing \['c', 'd'\] arguments as keywords is deprecated",
        ...
        pytest.param(
            ...
            (1, 2, 3),
            {"d": 4},
            r"Passing 'd' as keyword is deprecated",
